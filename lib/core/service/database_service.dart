...
class DatabaseService {
  ...
  Future<Map<String,dynamic>?> loadUser(String uid)async{
    ...
    try {
    final res=  await _fire.collection("users").where("uid",isNotEqualTo:currentUserId).get();
...
return res.docs.map((e)=>e.data()).toList();
  ...
  Stream<QuerySnapshot<Map<String, dynamic>>> fetchUserStream(String currentUserId) =>_fire.collection("users").where("uid",isNotEqualTo:currentUserId).snapshots();
}
