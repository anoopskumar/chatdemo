...
class ChatBubble extends StatelessWidget {
  const ChatBubble({super.key, this.isCurrentUser = true,required this.message});
  ...
  Widget build(BuildContext context) {
    ...
    return Align(
      alignment: alignment,
      child: Container(
        constraints: BoxConstraints(maxWidth: 1.sw * .75, minWidth: 50.w),
        padding: EdgeInsets.all(10),
        decoration: BoxDecoration(
          borderRadius: borderRadius,
          color: isCurrentUser ? primary : grey.withOpacity(.2),
        ),
        child: Column(
          crossAxisAlignment:
