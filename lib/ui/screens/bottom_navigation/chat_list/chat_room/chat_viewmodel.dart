...
class ChatViewmodel extends BaseViewmodel {
  ...
  saveMessage()async{
    ...
    try {
      ...
      final message =Message(id: now.millisecondsSinceEpoch.toString(),content: _messageController.text,senderId: _currentUser.uid,receiverId: _receiver.uid, timestamp: now);
